...
>
	...
	<div slot="content">
		<DropdownMenu.Content
			class="z-[10000] text-black dark:text-white rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 flex flex-col bg-white dark:bg-slate-800 w-70 p-1.5"
			sideOffset={8}
			side="bottom"
			align="start"
