				...
				>
					...
					<div class="flex justify-between items-center gap-2 mt-2">
						<div class="shrink-0">
							...
							<button
								type="button"
								class="px-3.5 py-1.5 text-sm font-medium bg-gray-50 hover:bg-gray-100 text-gray-900 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-gray-200 transition rounded-lg"
						...
						<div class="flex gap-2 shrink-0">
							{#if !loading}
								<button
									...
									class="px-3.5 py-1.5 text-sm font-medium bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-slate-100 transition rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
