				...
				>
					...
					<div class="flex justify-between items-center gap-2 mt-2">
						<div class="shrink-0">
							...
							<button
								type="button"
								class="px-3.5 py-1.5 text-sm font-medium bg-gray-50 hover:bg-gray-100 text-gray-900 dark:bg-slate-800 dark:hover:bg-gray-800 dark:text-gray-200 transition rounded-lg"
