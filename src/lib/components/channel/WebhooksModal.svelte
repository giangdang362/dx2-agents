		...
		<div>
			<div class="flex justify-between dark:text-gray-100 px-5 pt-4 mb-1.5">
				<div class="flex w-full justify-between items-center mr-3">
					...
					<button
						type="button"
						class="px-3 py-1.5 gap-1 rounded-xl bg-gray-100/50 dark:bg-slate-800 text-black dark:text-white transition font-medium text-xs flex items-center justify-center"
			...
			<div class="flex flex-col w-full px-4 pb-4 dark:text-gray-200">
				...
				>
					...
					<div class="flex justify-end text-sm font-medium gap-1.5">
						<button
							class="px-3.5 py-1.5 text-sm font-medium bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-slate-100 transition rounded-full flex flex-row space-x-1 items-center {isSaving
								? 'cursor-not-allowed'
								: ''}"
							type="submit"
							disabled={isSaving}
