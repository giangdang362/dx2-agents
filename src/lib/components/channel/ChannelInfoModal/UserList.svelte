		...
		<div class="flex items-center justify-between px-2 mb-1">
			...
			{#if onAdd}
				<div class="">
					<button
						type="button"
						class=" px-3 py-1.5 gap-1 rounded-xl bg-gray-100/50 dark:text-white dark:bg-slate-800 text-black transition font-medium text-xs flex items-center justify-center"
						on:click={onAdd}
					>
