...
<div class="text-xs -mx-1">
	...
	<button
		type="button"
		class="w-full flex items-center gap-3 px-3.5 py-3 hover:bg-gray-50 dark:hover:bg-slate-800 rounded-xl transition"
		on:click={onClick}
	>
		<img
			src={image || `${WEBUI_BASE_URL}/static/cmc-logo-loading.png`}
