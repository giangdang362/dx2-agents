			...
			<div class=" flex flex-col w-full sm:flex-row sm:justify-center sm:space-x-6">
				...
				>
										...
										<div class="flex mt-0.5 mb-0.5 space-x-2">
											<div class=" flex-1">
												{#if variables[variable]?.type === 'select'}
													...
													<select
														class="w-full rounded-lg py-2 px-4 text-sm dark:text-gray-300 dark:bg-slate-800 outline-hidden border border-gray-100/30 dark:border-gray-850/30"
													...
													<div class="flex items-center space-x-2">
														<div class="relative flex justify-center items-center gap-2 flex-1">
															<input
																type="range"
																bind:value={variableValues[variable]}
																class="w-full rounded-lg py-1 px-4 text-sm dark:text-gray-300 dark:bg-slate-800 outline-hidden border border-gray-100/30 dark:border-gray-850/30"
																id="input-variable-{idx}"
																{...variableAttributes}
															/>
														</div>
					...
					<div class="flex justify-end pt-3 text-sm font-medium">
						<button
							class="px-3.5 py-1.5 text-sm font-medium bg-white hover:bg-gray-100 text-black dark:bg-black dark:text-white dark:hover:bg-slate-800 transition rounded-full"
							type="button"
							on:click={() => {
								show = false;
							}}
						...
						<button
							class="px-3.5 py-1.5 text-sm font-medium bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-slate-100 transition rounded-full"
							type="submit"
						>
							{$i18n.t('Save')}
						</button>
