		...
		<div>
			<div class="space-y-2">
				<div>
					...
					<div class="flex w-full">
						<div class="flex-1 mr-2">
							<input
								class="w-full rounded-lg py-2 px-4 text-sm bg-gray-50 dark:text-gray-300 dark:bg-slate-800 outline-hidden"
				...
				<div>
					...
					<div class="flex w-full">
						<div
							class="flex-1 mr-2 pr-1.5 rounded-lg bg-gray-50 dark:text-gray-300 dark:bg-slate-800"
						>
							<select
					...
					<div class="flex w-full">
						<div class="flex-1 mr-2 flex flex-col gap-2">
							...
							<textarea
								...
								class="w-full rounded-lg py-2 px-4 text-sm bg-gray-50 dark:text-gray-100 dark:bg-slate-800 outline-hidden resize-none scrollbar-hidden"
								rows="6"
							...
							<div class="flex flex-col w-full">
								{#if modelUploadMode === 'file'}
									<div class="flex-1 {modelInputFile && modelInputFile.length > 0 ? 'mr-2' : ''}">
										...
										<button
											type="button"
											class="w-full rounded-lg text-left py-2 px-4 bg-gray-50 dark:text-gray-300 dark:bg-slate-800"
											on:click={() => {
								...
								{:else}
									<div class="flex-1 {modelFileUrl !== '' ? 'mr-2' : ''}">
										<input
											class="w-full rounded-lg text-left py-2 px-4 bg-gray-50 dark:text-gray-300 dark:bg-slate-800 outline-hidden {modelFileUrl !==
											''
												? 'mr-2'
												: ''}"
											type="url"
							...
							<div>
								<div>
									...
									<textarea
										...
										class="w-full rounded-lg py-2 px-4 text-sm bg-gray-50 dark:text-gray-100 dark:bg-slate-800 outline-hidden resize-none"
										rows="6"
									/>
								</div>
							</div>
